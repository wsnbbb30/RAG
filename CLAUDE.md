...
PaiSmart (派聪明) is an enterprise-grade AI knowledge management system built with RAG (Retrieval-Augmented Generation) technology. It provides intelligent document processing and retrieval capabilities using a modern backend stack including Spring Boot, Elasticsearch, and AI services.
...
2. Update database schema if needed (JPA auto-generates DDL)
3. Test with both unit and integration tests
